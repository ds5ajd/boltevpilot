...
class CarInterface(CarInterfaceBase):
  ...
  def get_pid_accel_limits(CP, current_speed, cruise_speed):
    ...
    accel_max_bp = [10., 20., 30., 50., 70., 80.] #[10., 20., 50.] => [10., 20., 35., 50., 70., 80.](Good)
    accel_max_v = [0.85, 0.9, 0.8, 0.8, 0.92, 0.95] #[0.8, 1.0, 1.0] => [0.8, 1.0, 0.95] => [0.85, 0.95, 0.8, 0.82, 1.0, 0.95](Good)
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=None, disable_radar=False):
    ...
    ret.longitudinalTuning.kpV = [1.18, 1.17, 0.9, 0.76] #[1.20, 1.0, 0.76], [1.16, 1.1, 0.76]=>good
    ret.longitudinalTuning.kiBP = [0., 18.0 * CV.KPH_TO_MS, 40.0 * CV.KPH_TO_MS, 80.0 * CV.KPH_TO_MS] #[0., 18.0 * CV.KPH_TO_MS, 80. * CV.KPH_TO_MS]
    ret.longitudinalTuning.kiV = [0.140, 0.135, 0.130, 0.115] #0.140,0.125,0.115, [0.135, 0.130, 0.115]=> good [0.135, 0.127, 0.115]
