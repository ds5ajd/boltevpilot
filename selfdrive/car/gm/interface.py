...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=None, disable_radar=False):
    ...
    ret.steerActuatorDelay = 0.27 # def: 0.2 Default delay, not measured yet
    ...
    if lateral_control == 'INDI':
      ...
      ret.steerRateCost = 0.35 #0.5
      ret.steerActuatorDelay = 0.27 #0.
    ...
    ret.longitudinalActuatorDelayUpperBound = 0.39 #0.35(Good) 0.45
