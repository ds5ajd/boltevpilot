...
class CarInterface(CarInterfaceBase):
  ...
  def get_pid_accel_limits(CP, current_speed, cruise_speed):
    ...
    accel_max_bp = [10., 20., 30., 50., 70., 85.] #good => [10., 20., 30., 50., 70., 80.]
    accel_max_v =[0.9, 0.95, 0.85, 0.82, 0.87, 0.91] #good => [0.9, 0.95, 0.85, 0.82, 0.87, 0.9]
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=None, disable_radar=False):
    ...
    ret.steerActuatorDelay = 0.2 # 0.01 late def: 0.2 Default delay, not measured yet
