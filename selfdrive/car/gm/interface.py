...
class CarInterface(CarInterfaceBase):
  ...
  def get_pid_accel_limits(CP, current_speed, cruise_speed):
    ...
    accel_max_v = [0.9, 0.9, 0.8, 0.8, 0.92, 0.95] #[0.8, 1.0, 1.0] => [0.8, 1.0, 0.95] => [0.85, 0.9, 0.8, 0.8, 0.92, 0.95](Good)
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=None, disable_radar=False):
    ...
    ret.longitudinalTuning.kiV = [0.140, 0.135, 0.130, 0.115] #0.140,0.125,0.115, [0.135, 0.130, 0.115]=> good [0.140, 0.135, 0.130, 0.115]
