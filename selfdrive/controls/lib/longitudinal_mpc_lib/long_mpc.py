...
A_EGO_COST = 0.
J_EGO_COST = 5.0
A_CHANGE_COST = 300. # 200. ==> 50 ==> 230 ==> 270(good) ==> 300
...
AUTO_TR_V = [0.4, 0.5, 0.525, 0.55, 0.575, 0.6, 0.625, 0.65, 0.7, 0.77, 1.0] #[1.1, 1.190, 1.240, 1.285, 1.475] => [1.01, 1.110, 1.170, 1.220, 1.380]

#AUTO_TR_BP = [0., 30.*CV.KPH_TO_MS,50.*CV.KPH_TO_MS, 70.*CV.KPH_TO_MS, 110.*CV.KPH_TO_MS]
#AUTO_TR_V = [0.6, 0.7, 0.7, 0.7, 1.1] #[1.1, 1.190, 1.240, 1.285, 1.475] => [1.01, 1.110, 1.170, 1.220, 1.380]
