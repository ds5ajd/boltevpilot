...
A_EGO_COST = 0.
J_EGO_COST = 5.0
A_CHANGE_COST = 150. # 200. ==> 50 ==> 230 ==> 270(good) ==> 200
...
#AUTO_TR_BP = [0., 30.*CV.KPH_TO_MS, 50.*CV.KPH_TO_MS, 70.*CV.KPH_TO_MS, 90.*CV.KPH_TO_MS, 110.*CV.KPH_TO_MS]
#AUTO_TR_V = [0.2, 0.6, 0.7, 0.77, 0.85 ]
