...
A_EGO_COST = 0.
J_EGO_COST = 5.0
A_CHANGE_COST = 200. # 200. ==> 50 ==> 230 ==> 270(good) ==> 150(Good)==>200
...
#AUTO_TR_BP = [0., 30.*CV.KPH_TO_MS, 40.*CV.KPH_TO_MS, 70.*CV.KPH_TO_MS, 90.*CV.KPH_TO_MS, 110.*CV.KPH_TO_MS]
#AUTO_TR_V = [0.3, 0.5, 0.7, 0.7, 0.77, 0.85 ]
...
AUTO_TR_V = [0.1, 0.2, 0.2, 0.4, 0.6, 0.7, 0.7, 0.7, 0.71, 0.71, 0.71] #[1.1, 1.190, 1.240, 1.285, 1.475] => [1.01, 1.110, 1.170, 1.220, 1.380] 
       #==> [0.4, 0.5, 0.6, 0.65, 0.7, 0.7, 0.7, 0.7, 0.75, 0.8, 1.0]
       #==> [0.1, 0.2, 0.2, 0.4, 0.6, 0.6, 0.7, 0.7, 0.7, 0.77, 1.0] good but still far below 30km/h
